...
<?php $__env->startSection('content'); ?>
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-slate-500">Track asset assignments and returns</p>
        </div>
        <a href="<?php echo e(route('assignments.create')); ?>" class="px-4 py-2 font-semibold text-white bg-blue-600 rounded-lg">+
            Assign Asset</a>
    </div>
        ...
        <table class="min-w-full text-sm">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="border-b">
                        <td class="px-4 py-3"><?php echo e($assignment->item->name ?? '-'); ?></td>
                        <td class="px-4 py-3"><?php echo e($assignment->user->name ?? '-'); ?></td>
                        <td class="px-4 py-3"><?php echo e($assignment->department->name ?? '-'); ?></td>
                        <td class="px-4 py-3"><?php echo e(optional($assignment->assigned_at)->format('d M Y H:i')); ?></td>
                        <td class="px-4 py-3"><?php echo e(optional($assignment->returned_at)->format('d M Y H:i') ?? '-'); ?></td>
                        <td class="px-4 py-3">
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td colspan="6" class="px-4 py-6 text-center text-slate-500">No assignments found.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
